...
- Telegram: [@forge_spirit](https://t.me/forge_spirit)
- Пожалуйста, только без жалоб на неработающий код <3.
- Репозиторий был оставлен публично, лишь как хороший MVP именно для Вашего локального бизнеса, но требует существенной доработки, интеграции с платежными системами, курьерским ролями, починку веб сайта и оптимизиации. Он не претендует на звание хорошего кода и, тем более, не планируется никакая поддержка кода. 
